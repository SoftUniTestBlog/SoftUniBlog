using BasicFunctionality.Pages.ArticleDeletePage;
using BasicFunctionality.Pages.ArticleDetailsPage;
using BasicFunctionality.Pages.ArticleEditPage;
using BasicFunctionality.Pages.ChangePasswordPage;
using BasicFunctionality.Pages.CreatePage;
using BasicFunctionality.Pages.LoginPage;
using BasicFunctionality.Pages.ManagePage;
using BasicFunctionality.Pages.RegistrationPage;
using BasicFunctionality.Pages.UserListPage;
using NUnit.Framework;
using NUnit.Framework.Interfaces;
using OpenQA.Selenium;
using OpenQA.Selenium.Chrome;
using BasicFunctionality.Pages.HomePage;
using System;
